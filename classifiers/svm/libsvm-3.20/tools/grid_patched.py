...
class Worker(Thread):
	...
	def run(self):
		while True:
			...
			#print self.name," Worker_run=",cexp,gexp
			#print "WorkerStopToken=",WorkerStopToken
...
def find_parameters(dataset_pathname, options=''):
	...
	#print "After GridOption=>",options.c_begin, options.c_end, options.c_step, options.grid_with_c, options.grid_with_g
	...
	#print "jobs=",jobs
	print "resumed_jobs=",resumed_jobs
	job_queue = Queue(0)
	...
	for i in range(nr_local_worker):
		#print "Local Worker=",str(i)
		#print "job_queue=",job_queue.qsize()
		#print "result_queue=",result_queue.qsize()
		#print "options=",options.c_begin,options.c_end,options.c_step,options.g_begin,options.g_end,options.g_step
